	...
	<div class="row">
			<div class="mx-auto float-left col-10" style="width:30%;" >
				...
				<div class="input-group mb-3">				
  					...
  					<input id="CustomerName" name="CustomerName" type="text" class="form-control" placeholder="Enter Name Here">
				</div>
				...
				<div class="input-group mb-3">				
  					...
  					<input id="Date" name="Date" type="text" class="form-control"  placeholder="Enter Date Here">
				</div>
				...
				<div class="input-group mb-3">				
  					...
  					<textarea id="Reason" name="Reason"  class="form-control" placeholder="Enter Reason Here"></textarea>
				</div>
